...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2019 at 01:30 AM
...
(3, 'Tes Uji Coba', 'Tes Uji Coba', '2019-02-01 07:26:00', '2019-02-02 07:26:00', 30, '*.*.*.*', 1, 0, '1.00', '0.00', '0.00', '10.00', 1);
...
(461, 'admin', 'tool-backup', 1, 1),
(462, 'admin', 'peserta-group', 1, 1),
(463, 'admin', 'peserta-daftar', 1, 1),
(464, 'admin', 'modul-daftar', 1, 1),
(465, 'admin', 'tes-daftar', 1, 1),
(466, 'admin', 'tes-evaluasi', 1, 1),
(467, 'admin', 'tool-exportimport-soal', 1, 1),
(468, 'admin', 'modul-filemanager', 1, 1),
(469, 'admin', 'tes-hasil', 1, 1),
(470, 'admin', 'tes-hasil-operator', 1, 1),
(471, 'admin', 'peserta-import', 1, 1),
(472, 'admin', 'modul-import', 1, 1),
(473, 'admin', 'user_level', 1, 1),
(474, 'admin', 'user_menu', 1, 1),
(475, 'admin', 'user_atur', 1, 1),
(476, 'admin', 'tes-rekap', 1, 1),
(477, 'admin', 'modul-soal', 1, 1),
(478, 'admin', 'tes-tambah', 1, 1),
(479, 'admin', 'tes-token', 1, 1),
(480, 'admin', 'modul-topik', 1, 1);
