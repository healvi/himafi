...
// Database Configuration
  $dbinfo = array(
    ...
    "db" => 'u592694108_s2',            // The database where you have dumped the included sql file
    "user" => 'u592694108_s2',        // Your mySQL username
    "password" => 'HIMAFIua123',    //  Your mySQL Password 
  ...
  $config = array(
     ...
     *    fail.
     *
     *  - If the two config below don't have any values or have 47cd9b242ad7a8e2ebc41a4ea69d2ca9 or 5fe7bbac7c1a4029706cfaae796cd9ef, replace these by a random key.
     ====================================================================================
    */
    "security" => '47cd9b242ad7a8e2ebc41a4ea69d2ca9',  // !!!! DON'T CHANGE THIS IF YOUR SITE IS LIVE !!!!
    "public_token" => '5fe7bbac7c1a4029706cfaae796cd9ef', // This is randomly generated and it is a public key
